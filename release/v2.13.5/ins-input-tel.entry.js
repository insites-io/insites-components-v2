...
const InsInputTel = class {
    constructor(hostRef) {
        ...
        this._phone_number_value = "";
        this._area_code_value = "";
    ...
    async setValue({ country, country_code, area_code, phone_number }) {
        ...
        if (country_code)
            this._iti.setNumber(country_code);
    ...
    render() {
        return (h("div", { key: '4e4061c61592306e587d469dcbfe6c7c0654b6f0', class: `ins-input-tel-wrap ins-form-field-wrap
        ${this.hasError ? 'is-invalid' : ''}
        ${this.responsiveView ? 'responsive' : ''}
        ${this.noAreacode ? 'no-areacode' : ''}
        ${this.readonly ? 'read-only' : ''} ` }, this.label || this.tooltip ?
            h("label", { class: "ins-form-label" }, this.label, this.tooltip
                ? h("ins-input-tooltip", { content: this.tooltip })
                : '')
            : '', h("div", { key: '341f62ddfeca1811c08fbf8bb42a5a6641b9c197', class: "row-col-container" }, h("div", { key: '54cba8e75e9afa41d18f88cf7f7fb9eaf304b03c', class: "col-container column-1" }, h("input", { key: '01dbe2b24d0692a7584bc0dfed4375f32c58d825', type: "tel", class: "phone ins-form-field", disabled: this.disabled, readonly: this.readonly })), h("div", { key: '2f61ddcda0fa837dfb37a4bc39a5b4223ec5b681', class: "col-container column-2" }, h("input", { key: '0d187f95b822babf532b497b44e8e1906d6967a6', type: "tel", tabindex: "0", maxlength: "5", class: "ins-form-field area-code", name: this.areaCode, placeholder: this.areacodePlaceholder, value: this.areacodeValue, required: this.required ? true : false, disabled: this.disabled, readonly: this.readonly })), h("div", { key: 'b0e0053d46e800c35156a3e9f71f5b8b3c3b7891', class: "col-container column-3" }, h("input", { key: '665bf97c491ad2309bf6049a868a5f67ac844a2d', type: "tel", tabindex: "0", maxlength: "13", class: "ins-form-field phone-number", name: this.phoneNumber, placeholder: this.phonenumPlaceholder, value: this.phonenumValue, disabled: this.disabled, readonly: this.readonly }))), this.hasError ?
            h("div", { class: "ins-form-error" }, this.errorMessage)
            : ''));
    }
    get insInputTelEl() { return getElement(this); }
};
InsInputTel.style = intlTelInputMinCss;

export { InsInputTel as ins_input_tel };

//# sourceMappingURL=ins-input-tel.entry.js.map