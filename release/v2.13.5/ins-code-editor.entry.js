...
import { c as codemirror, C as CodeMirror$1 } from './yaml-dcd17309.js';
import './_commonjsHelpers-bc8ff177.js';

var autorefresh$1 = {exports: {}};
...
}(autorefresh$1, autorefresh$1.exports));

const autorefresh = autorefresh$1.exports;
...
const InsCodeEditor = class {
    ...
    componentDidLoad() {
        ...
        this.codeMirrorEl = CodeMirror$1.fromTextArea(textarea, {
            autoRefresh: true,
        ...
        CodeMirror$1.commands["selectAll"](this.codeMirrorEl);
        this.setEvents();
        this.hideCursor();
    ...
    render() {
        return (h("div", { key: 'e9140b2719e2d0fdfd1d0cde0d95f69f30c3a457', class: "ins-code-editor" }, h("div", { key: 'e55fa60d268904a1b5115b7e4a4c1f4ceefe9e5b', class: (this.hasError ? 'has-error ' : '') + (this.readonly ? 'readonly ' : '') + (this.activeLabel ? 'active ' : '') + (this.autoHeight ? 'auto-height' : '') }, this.label || this.tooltip ?
            h("label", null, this.label, this.tooltip
                ? h("ins-input-tooltip", { content: this.tooltip })
                : '')
            : '', h("textarea", { key: '8775cb2cadff2d13d69d9029b4636e5c936b89e0', name: this.name, class: "codemirror" }), h("div", { key: 'd29900d1e48029e69724105941266c17c952b043', class: "ins-form-error" }, this.errorMessage))));
    }
    get insCodeEditorEl() { return getElement(this); }
};
InsCodeEditor.style = insCodeEditorCss;

export { InsCodeEditor as ins_code_editor };

//# sourceMappingURL=ins-code-editor.entry.js.map