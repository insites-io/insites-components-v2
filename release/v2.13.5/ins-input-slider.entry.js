...
import { g as getDefaultExportFromCjs } from './_commonjsHelpers-bc8ff177.js';

var rangeSlider$1 = {exports: {}};
...
}(rangeSlider$1, rangeSlider$1.exports));

const rangeSlider = /*@__PURE__*/getDefaultExportFromCjs(rangeSlider$1.exports);
...
const InsInputSlider = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.insSlide = createEvent(this, "insSlide", 7);
        this.insSlideStart = createEvent(this, "insSlideStart", 7);
        this.insSlideEnd = createEvent(this, "insSlideEnd", 7);
    ...
    renderLabelInput() {
        return (h("label", { class: `ins-input-slider_label
         ${this.label ? "" : "no-label"}` }, this.label, h("input", { type: "number", class: "ins-input-slider_label-input", min: this.min, max: this.max, step: this.step, value: this.value || this.min, disabled: this.disabled }), this.tooltip
            ? h("ins-input-tooltip", { content: this.tooltip })
            : ''));
    }
    render() {
        if (!this.max)
            return (h("div", null, "Please set the max attribute to render ins-input-slider"));
        return (h("div", { class: `ins-input-slider ${this.position}
        ${this.disabled ? 'disabled' : ''}
        ${this.sliderOnly ? 'slider-only' : ''}` }, (this.position === "left" || this.position === "top") && !this.sliderOnly
            ? this.renderLabelInput()
            : "", this.sliderOnly ? "" : h("span", { class: "ins-input-slider_min" }, this.min), h("input", { type: "range", min: this.min, max: this.max, step: this.step, disabled: this.disabled, name: this.name, value: this.value || this.min }), this.sliderOnly ? "" : h("span", { class: "ins-input-slider_max" }, this.max), (this.position === "right" || this.position === "bottom") && !this.sliderOnly
            ? this.renderLabelInput()
            : "", this.hasError ?
...
InsInputSlider.style = rangeSliderCss;

export { InsInputSlider as ins_input_slider };

//# sourceMappingURL=ins-input-slider.entry.js.map