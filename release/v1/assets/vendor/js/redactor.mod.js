...
(function() {
    ...
    Dom.prototype = {
        ...
        // removeStyleTag: function(value) {
        //     value = value.replace('</style>', '');
        //     value = value.replace(new RegExp("<style([\\s\\S]+?)>", 'gi'), '').replace('<style>', '');
        //     return value;
        // },
        // formatStyles: function(value) {
        //     var indices = [];
        //     var index = 0;
        //     var new_value = value;
        ...
        //         start = value.indexOf('<style');
        //         end = (value.indexOf('</style>') + 8) - start;
        //         if (start < 0) {
        //            index = -1;
        //         } else {
        //             var temp_str = value.substr(start, end);
        ...
        // },
        // convertValues(value) {
        //     value = value.replace('<span id="selection-marker-start" class="redactor-selection-marker"></span><span id="selection-marker-end" class="redactor-selection-marker"></span>', '');
        //     var data = this.formatStyles(value);

        //     var converted_styles = '<style>';
        //     for (counter = 0; counter < data.index.length; counter++) {
        //         var temp_str = this.removeStyleTag(value.substr(data.index[counter].start, data.index[counter].end));
        //         converted_styles += this.convertStyles(temp_str);
        //     }
        //     converted_styles += '</style>';

        //     return converted_styles + data.value;
        // },
        // convertString: function(value, delimeter) {
        //     var new_value = '';
        ...
        //     return new_value;
        // },
        // convertStyles: function(value) {
        //     value = value.replace(/\{/g, ' { ').replace(/\}/g, ' } ').replace(/\s+/g, " ").trim().split(' } ');
        //     for (var counter = 0; counter < value.length; counter++) {
        //         value[counter] = '.redactor-styles ' + value[counter];
        //         value[counter] = value[counter].replace(/,/g, ', .redactor-styles');
        //     }
